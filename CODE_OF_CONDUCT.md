...
repository maintainers. If no private community contact is listed, use the
repository's private security-reporting channel and label the message as a conduct
report. Reports will be reviewed promptly and fairly. Maintainers will respect the
privacy and security of reporters and affected people as far as reasonably
possible.
...
2.1, available at [the Contributor Covenant text][version].
